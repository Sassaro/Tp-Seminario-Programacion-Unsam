...
class Transition(threading.Thread):
    ...
    def run(self):
        ...
        while aux:
            ...
            print(f"M: {p1.tokens, p2.tokens, p3.tokens,p4.tokens,p5.tokens, p6.tokens}")
            semaphore.release()
...
p4 = Place(1, 'P4')
p5 = Place(0, 'P5')
p6 = Place(9, 'P5')  # 9 es la maxima cantidad de tokens que puede haber en p3
